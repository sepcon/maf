...
public:
    ...
    void onEntry() override
    {
        ...
        _stub->registerRequestHandler<clear_all_status_request>(
...
//            request->error("Some error occurred while clearing statuses!");
    ...
    void setStatus()
    {
        _stub->setStatus<compliance5::status>(false, true, 0, SStatus);

...
#   define client_server_contract_object_s(ActionName, Type)                													\
           class ActionName##Type : public maf::messaging::ipc::SerializableMessageContentBase                                                 \
           {                                                                                                                    \
           public:                                                                                                              \
               maf::srz::ByteArray toBytes() const override                                                                    \
               {                                                                                                                \
               ...
               static maf::messaging::ipc::OpID ID() { return OpID_##ActionName; }                                             \
               maf::messaging::ipc::OpID getName() const override { return ID(); }                                               \
                                                                                                                                \
           public:                                                                                                              \

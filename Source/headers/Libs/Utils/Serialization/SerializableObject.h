...
#define HAS_PROPERTIES(MemberNameList, ...) HAS_PROPERTIES_PRV_(MemberNameList, __VA_ARGS__)

#define WITH_RESPECTIVE_TYPES(...) WITH_RESPECTIVE_TYPES_PRV_(__VA_ARGS__)

#define DEFINE_GET_SET_METHODS(Type, Name) DEFINE_GET_SET_METHODS_PRV_(Type, Name)

...
inline bool debugAllowed() { return allowed(LogLevel::LOG_LEVEL_DEBUG); }
inline bool infoAllowed() { return allowed(LogLevel::LOG_LEVEL_INFO); }
inline bool warnAllowed() { return allowed(LogLevel::LOG_LEVEL_WARN); }
inline bool errorAllowed() { return allowed(LogLevel::LOG_LEVEL_ERROR); }
inline bool fatalAllowed() { return allowed(LogLevel::LOG_LEVEL_FATAL); }
inline bool verboseAllowed() { return allowed(LogLevel::LOG_LEVEL_VERBOSE); }

...
#define maf_map2d_template template <typename Key1, typename Key2, typename Value>

maf_map2d_template
using Map2D = std::map<Key1, std::map<Key2, Value>>;

maf_map2d_template
Value find(const Map2D<Key1, Key2, Value>& map2d, const Key1& k1, const Key2& k2)
{
